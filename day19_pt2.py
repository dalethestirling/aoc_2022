...
minutes = 32 
product_geodes = 1
for bpid, cost_ore_robot, cost_clay_robot, ob_ore, obs_clay, geode_ore, geode_ob in blueprint_model[:3]:
    cost_per_robot = [
    ...
    mined = bfs(cost_per_robot, (1, 0, 0, 0), minutes, top_queue = 10000)
    product_geodes *= mined

print("Product of geodes from the first 3 blueprints: %d" % product_geodes)
