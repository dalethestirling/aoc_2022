...
def dance_elf_dance():
    ...
    rounds = 0
    while True:
        proposed = do_round(elf_positions, first_considered=rounds % 4)

        if proposed == elf_positions:
            break
        rounds += 1
...
if __name__ == '__main__':
    print('Number of rounds it takes to get into position: %d' % dance_elf_dance())
